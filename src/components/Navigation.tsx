    ...
    <>
      <nav
        className={`fixed top-0 left-0 right-0 z-50 transition-all duration-500 ${
          scrolled
            ? 'bg-bosque/95 backdrop-blur-md shadow-lg py-3'
            : 'bg-transparent py-5'
        }`}
      >
        <div className="w-full section-padding flex items-center justify-between">
          ...
          >
            ...
            <div className={`hidden sm:block transition-opacity duration-300 ${scrolled ? 'opacity-100' : 'opacity-0'}`}>
              ...
              <span className="block text-[9px] text-dorado tracking-widest">
          ...
          <div className="flex items-center gap-3">
            ...
            <a
              ...
              className="hidden sm:flex items-center gap-2 px-4 py-2 bg-white/10 hover:bg-white/20 text-white rounded-sm transition-all text-sm font-medium"
            >
      ...
      {/* Mobile Menu Overlay */}
      <div
        className={`fixed inset-0 z-40 bg-bosque/98 backdrop-blur-lg transition-all duration-500 lg:hidden ${
      ...
      >
        <div className="flex flex-col items-center justify-center h-full gap-6">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="mt-4 flex items-center gap-2 px-6 py-3 bg-dorado text-tierra rounded-sm font-medium"
          >
